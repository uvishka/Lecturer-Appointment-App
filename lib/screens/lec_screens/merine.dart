...
class MerineLecData extends StatefulWidget {
  const MerineLecData({super.key});

  @override
  State<MerineLecData> createState() => _MerineLecDataState();
}

class _MerineLecDataState extends State<MerineLecData> {
  ...
  void initState() {
    ...
    lecturerStream =
        lecturerCollection.where('department', isEqualTo: 'DIS').snapshots();
  }
