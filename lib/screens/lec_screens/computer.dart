...
class ComputeLecData extends StatefulWidget {
  const ComputeLecData({super.key});

  @override
  State<ComputeLecData> createState() => _ComputeLecDataState();
}

class _ComputeLecDataState extends State<ComputeLecData> {
