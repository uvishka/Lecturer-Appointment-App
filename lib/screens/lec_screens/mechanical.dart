...
class MechanicalLecData extends StatefulWidget {
  const MechanicalLecData({super.key});

  @override
  State<MechanicalLecData> createState() => _MechanicalLecDataState();
}

class _MechanicalLecDataState extends State<MechanicalLecData> {
  ...
  void initState() {
    ...
    lecturerStream =
        lecturerCollection.where('department', isEqualTo: 'DMME').snapshots();
  }
