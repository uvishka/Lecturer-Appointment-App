...
class IsLecData extends StatefulWidget {
  const IsLecData({super.key});

  @override
  State<IsLecData> createState() => _IsLecDataState();
}

class _IsLecDataState extends State<IsLecData> {
